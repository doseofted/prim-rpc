...
<div class="flex gap-4">
	<a href="/docs/v0/usage/setup" class="not-prose btn">
		<Icon class="w-6 h-6" name="ph:notebook-fill"></Icon>
		<span>Get Started</span>
	</a>
	<a href="/docs/v0/usage/examples" class="not-prose btn">
...
<div class="flex gap-4">
	<a href="https://github.com/doseofted/prim-rpc" class="not-prose btn">
		<Icon class="w-6 h-6" name="simple-icons:github"></Icon>
		<span>GitHub</span>
	</a>
	<a href="https://www.threads.net/@doseofted" class="not-prose btn">
		<Icon class="w-6 h-6" name="simple-icons:threads"></Icon>
		<span>Threads</span>
	</a>
	<a href="https://doseofted.me/" class="not-prose btn">
