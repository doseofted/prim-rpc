...
<Aside
	message="You're all set up! See the advanced setup guide to continue and support callbacks on your functions as well as additional types."
	type="success"
/>

<div class="flex gap-4 mt-6">
	<a href="/docs/v0/usage/advanced" class="not-prose btn">
		<Icon class="w-6 h-6" name="ph:toolbox-bold"></Icon>
