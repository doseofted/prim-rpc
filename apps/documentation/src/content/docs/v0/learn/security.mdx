...
Prim+RPC uses the default JSON "stringify" method to serialize RPC and the [destr](https://github.com/unjs/destr)
...
vulnerabilities. If your custom JSON handler allows additional types or supports circular references to be used,
consider how this may impact your code.
