...
<Aside type="success">You've finished the advanced guide!</Aside>

## Next Steps

There are many features available in Prim+RPC that we haven't even touched yet. You could (and should) validate
arguments inside of your functions, using the validation library of your choice. You may define methods on other methods
or swap out your server framework. See the [usage guide](/docs/v0/learn/usage) or one of the
