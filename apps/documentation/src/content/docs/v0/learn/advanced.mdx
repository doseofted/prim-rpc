...
the [configuration reference](/docs/v0/reference/config) or one of the [available examples](/docs/v0/learn/examples) to
learn more about what can be done with Prim+RPC.

<div class="flex gap-4 mt-6">
	<a href="/docs/v0/reference/config" class="not-prose btn">
		<Icon class="w-6 h-6" name="ph:wrench-bold"></Icon>
