...
There are many features available in Prim+RPC that we haven't even touched yet. You may both upload _and_ download files
from your functions. You can define methods on other methods. You may swap out your server framework. See the
[usage guide](/docs/v0/learn/usage) or one of the [available examples](/docs/v0/learn/examples) to learn more about what
can be done with Prim+RPC.

<div class="flex gap-4 mt-6">
	<a href="/docs/v0/learn/usage" class="not-prose btn">
		<Icon class="w-6 h-6" name="ph:lightbulb-bold"></Icon>
		<span>Usage</span>
	</a>
