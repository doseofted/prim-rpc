...
While we could stop right here, Prim+RPC can do much more. See the [advanced guide](/docs/v0/learn/advanced) to continue
on and send and receive Files, work with callbacks, and work with more types.

<div class="flex gap-4 mt-6">
	<a href="/docs/v0/learn/advanced" class="not-prose btn">
