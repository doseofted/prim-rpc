...
separate folders, a monorepo, or across two repositories and using a registry). If you don't, you can use
...
<Collapse collapseId="optionalChoices" title="Optional Choices">
