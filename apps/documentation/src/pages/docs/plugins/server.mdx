...
| --------------------------------------------------------------------------------------------------------------------------------- | -------------- | -------------- | ------------ |
| [Fetch API](https://github.com/wintercg/fetch) ([Bun](https://github.com/oven-sh/bun) / [Deno](https://github.com/denoland/deno)) | Method handler | HTTP           | `File`       |

Prim+RPC supports the Fetch API used in Bun and Deno. The plugin accepts a standard `Request` and returns a standard
`Response`.
