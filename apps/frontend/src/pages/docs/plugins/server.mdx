...
server you must also specify a compatible _plugin_ on the client. For plugins/handlers to be compatible they must use
the same type of transport (given in **Transport Type** in tables below).
