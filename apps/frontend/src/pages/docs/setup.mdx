...
can easily download an example project to follow along. The command below will download the example project or you can
download the it [directly from GitHub](https://github.com/doseofted/prim-rpc-examples/tree/main/starter):
