...
In this guide, we'll learn how to set up an existing project to use Prim+RPC. If you're starting a new project, you can
also follow this guide. You may reference [the available examples](/docs/examples) on this website to act as a starting
point.

Once you've set up your project, you can [learn how to write a function](/docs/usage) to be shared as Prim+RPC.
