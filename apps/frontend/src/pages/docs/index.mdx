...
a necessary stepping block for me to [build Prim+CMS](/cms), for which I'll be announcing more details in the future. I
chose to make this project open source for several reasons but primarily because many of the tools that I use today are
also open source. The availability of these tools are a big part of why I am a developer today and that ecosystem is
something for which I hope that I can contribute back. I hope that you find this library useful and that it helps other
developers like yourself whether you are experienced or just starting out.

If you do find this tool useful, consider giving it a [star on Github](https://github.com/doseofted/prim-rpc), sharing
with others, contributing back to the project (whether to the core project or a plugin for it), sponsoring the project,
or by [working with Ted on a new project](https://doseofted.com/).
