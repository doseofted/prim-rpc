...
incredibly useful but do not appear to be a very popular feature in JavaScript yet. Generator functions are not
...
look into further to determine if this is possible or needs to become a permanent limitation (Prim+RPC is in early
stages).
