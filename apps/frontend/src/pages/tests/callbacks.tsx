		...
		<>
			<div>
				<div class="flex gap-4">
					<input
						type="text"
						class="border-gray border rounded-full px-6 py-1"
						value={textInput()}
						onChange={e => {
					...
					/>
					<button class="bg-gray hover:bg-light-gray px-6 py-1 rounded-full" onClick={() => setName(textInput())}>
						Change Text
					</button>
				</div>
				<p>{typed()}</p>
