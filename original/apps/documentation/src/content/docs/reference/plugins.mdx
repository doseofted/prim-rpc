...
You may customize how Prim+RPC works by swapping out the serialization library or adding validation with your favorite
libraries.

<PluginChoices transport="inapplicable"></PluginChoices>
